...
%Check if orientation is off



[~, Lith_orientation] = ismember(Lith_T1w_orientation,FS_Orig_orientation);


%Since the orientations are off, lets swap them back
FS_Orig_MRIVoxels = permute(FS_Orig_MRIVoxels,Lith_orientation); % swapped matrix
