%function Lithium_Pipeline_Main_NoT1w(List,Lithium_Img_List,FS_Folder_List,Overall_Output_Dir,dicm2nii_path)
...
Overall_Output_Dir="/Users/ngh92/Desktop/Bliss_Output_No_T1_Test";
...
for i=1:length(List_Import)
    ...
    No_Lithium_No_Problem(Lithium_Img_List(i),FS_Folder_List(i),strcat(Overall_Output_Dir,"/",List_Import(i)))
